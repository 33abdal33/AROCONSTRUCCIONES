...
namespace AROCONSTRUCCIONES.Persistence.Migrations
{
    ...
    [Migration("20251217170717_nuevasEdicionesParaLaEntidadDetalleOC-y-MuchosMas")]
    partial class nuevasEdicionesParaLaEntidadDetalleOCyMuchosMas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AROCONSTRUCCIONES.Models.DetalleOrdenCompra", b =>
                {
                    ...
                    b.Property<int?>("IdDetalleRequerimiento")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdDetalleRequerimiento");
            ...
            modelBuilder.Entity("AROCONSTRUCCIONES.Models.OrdenCompra", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaEntregaPactada")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AROCONSTRUCCIONES.Models.Partida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AROCONSTRUCCIONES.Models.DetalleOrdenCompra", b =>
                {
                    b.HasOne("AROCONSTRUCCIONES.Models.DetalleRequerimiento", "DetalleRequerimientoOrigen")
                        .WithMany()
                        .HasForeignKey("IdDetalleRequerimiento")
                    ...
                    b.Navigation("DetalleRequerimientoOrigen");
            ...
            modelBuilder.Entity("AROCONSTRUCCIONES.Models.MovimientoInventario", b =>
                {
                    ...
                    b.HasOne("AROCONSTRUCCIONES.Models.Partida", "Partida")
                        .WithMany()
